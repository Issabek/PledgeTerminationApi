...
{
    public partial class LogMobileErrorInfo
    {
        public LogMobileErrorInfo()
        {
            LogMobileErrorNotifyEmails = new HashSet<LogMobileErrorNotifyEmail>();
        }
        ...
        public virtual ICollection<LogMobileErrorNotifyEmail> LogMobileErrorNotifyEmails { get; set; }
    }
}
