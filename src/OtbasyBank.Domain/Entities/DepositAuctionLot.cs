...
{
    public partial class DepositAuctionLot
    {
        public DepositAuctionLot()
        {
            ...
            DepositAuctionMails = new HashSet<DepositAuctionMail>();
            DepositAuctionPrivetLots = new HashSet<DepositAuctionPrivetLot>();
        }
        ...
        /// <summary>
        /// Сумма накопления на момент создания лота
        /// </summary>
        ...
        public virtual ICollection<DepositAuctionMail> DepositAuctionMails { get; set; }
        public virtual ICollection<DepositAuctionPrivetLot> DepositAuctionPrivetLots { get; set; }
    }
}
