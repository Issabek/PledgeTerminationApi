...
namespace OtbasyBank.Shared.Helpers
{
    ...
    { // This constant string is used as a "salt" value for the PasswordDeriveBytes function calls.
      ...
      //private static readonly byte[] initVectorBytes = Encoding.ASCII.GetBytes("IAMBESTOFTHEBEST007");
        ...
        /// Шифрует
        /// </summary>
        public static string Encrypt(string plainText, string passPhrase, int authId)
        {
            int userId = authId;
        ...
        public static string DecryptOld(string cipherText, string passPhrase)
        {
            ...
            try
            {
                ...
                using (PasswordDeriveBytes password = new PasswordDeriveBytes(passPhrase, null))
                {
                    ...
                    {
                        symmetricKey.Mode = CipherMode.CBC;
                        using (ICryptoTransform decryptor = symmetricKey.CreateDecryptor(keyBytes, Encoding.ASCII.GetBytes("IAMBESTOFTHEBEST")))
                        {
